...
RSS_URL = "https://udi.nmpa.gov.cn/rss/download.html?files=all"
...
def parse_rss():
    ...
    for entry in feed.entries:
        title = entry.title
        # 所有版本可能包含多种后缀
        if "UDID_ALL_" in title or "UDID_ALLUPDATE_" in title:
            date_str = (
...
def main():
    parser = argparse.ArgumentParser(description="UDI所有版本数据下载工具")
